...
- **Follow-up (same session, owner-directed)**: pattern review of the duration table and the whole fix (research docs/upstream for a derived-duration or player-reuse pattern; verdict to be recorded here).
