...
| 8 | Phones set to other timezones: dates follow the prayer timezone (needed for v2.0) | `fix/year-boundary` | ✅ (3T check next) |
...
| 12 | Launch time: measure a production build on the 3T | `perf/launch-time` | ⏳ |
